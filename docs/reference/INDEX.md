...
|                  | [provider-wire/](provider-wire/README.md) — version-pinned Codex + Claude wire shapes, TRUST/PROVENANCE-graded; Codex regenerated from the `0.149.1` binary, Claude censused from the `2.1.245` binary |
