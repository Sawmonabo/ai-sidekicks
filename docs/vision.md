...
| Push notifications | `@pushforge/builder` | V2 | Cross-device notifications via FCM/APNs. V1 delivers notifications to currently-connected devices via SSE only; V2 adds push delivery per [Spec-019 §Cross-Device Delivery](./specs/019-notifications-and-attention-model.md). Not listed in ADR-015 V1 or V1.1; defaults to V2 per [ADR-015 §V2 (Out of Scope for the V1 Horizon)](./decisions/015-v1-feature-scope-definition.md#v2-out-of-scope-for-the-v1-horizon). |
