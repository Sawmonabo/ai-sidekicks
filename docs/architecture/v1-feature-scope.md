...
| 20 | Session goals | [Spec-016](../specs/016-multi-agent-channels-and-orchestration.md) (goal set/clear RPC — campaign B6, **in-tree**: landed 2026-07-06, `Spec-016 §Session Goals`; `session.goal_*` events per the 2026-07-02 Spec-006 B1 amendment, **in-tree**: merged via PR #173 — both specs re-promoted `approved` 2026-07-18, the W1.5 gate / Task 28; Spec-016 since re-flipped `review` 2026-07-21 by the campaign B15 §Stop Conditions amendment, restored by Plan-016's W2.5 targeted re-audit) |
