...
| Take terminal control (release is holder-gated, role-independent — a holder demoted mid-hold can still relinquish, per Spec-003 §Required Behavior) | Yes | Yes | No | No |
