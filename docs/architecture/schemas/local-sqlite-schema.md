...
CREATE TABLE session_content_keys (
  ...
  encrypted_key_blob BLOB NOT NULL,           -- XChaCha20-Poly1305-wrapped AES-256 session content key (wire: nonce || ciphertext || tag) — the participant_keys.encrypted_key_blob custody shape
