...
CREATE TABLE session_terminal_leases (
  ...
  holder_user_id UUID REFERENCES users(id) ON DELETE SET NULL,  -- NULL = lease free (writes refused; Spec-002 null-holder-refuses-writes)
