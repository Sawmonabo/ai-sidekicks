...
- References: [Plan-002](../plans/002-invite-membership-and-presence.md):218-257 (Phase 2 + tasks T2.1–T2.5), [ADR-010](../decisions/010-paseto-webauthn-mls-auth.md) (PASETO v4 auth model), [CP-002-4](../plans/002-invite-membership-and-presence.md#cross-plan-obligations)
