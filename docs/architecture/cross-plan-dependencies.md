...
graph TB
  ...
  NS26[NS-26: Plan-002 Phase 3<br/>presence heartbeat + ChannelList projection]:::ready
...
- Status: `ready` (NS-26 promoted 2026-05-24 via NS-25 closure in PR #105 — both upstream conditions now satisfied: NS-24 Phase 1 contracts + `0002-session-invites` migration shipped via PR #102, NS-25 Phase 2 invite/membership services shipped via PR #105; Phase 3 (presence heartbeat + ChannelList projection per CP-002-1/CP-002-2 on the Plan-007-partial wire substrate) is dispatchable)
- Type: code
- Priority: `P1`
