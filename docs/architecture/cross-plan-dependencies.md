...
graph TB
  ...
  NS25[NS-25: Plan-002 Phase 2<br/>invite + membership services + PASETO v4.local consumer]:::ready
...
- Status: `ready` (NS-25 promoted 2026-05-23 via NS-24 closure in PR #102 — both upstream conditions now satisfied: NS-24 Phase 1 contracts + `0002-session-invites` migration shipped, and `packages/crypto-paseto/` v4.local substrate shipped 2026-05-21 via PR #92; Phase 2 service-layer wiring (invite-service.ts + membership-service.ts) is dispatchable)
- Type: code
