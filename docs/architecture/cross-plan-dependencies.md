...
flowchart TD
 ...
 n004_3B["Plan-003 Phase 3B — rollback time-travel cluster"]
 n004_4["Plan-003 Phase 4 — desktop run controls"]
 %% Plan-004
 n005_3B["Plan-004 Phase 3B — provider-account seam and usage-limit signal"]
 n005_5["Plan-004 Phase 5 — MCP task-handle durability"]
 %% Plan-005
 n006_3B["Plan-005 Phase 3B — machine-authored content column"]
 n006_4["Plan-005 Phase 4 — read side, SDK, desktop stub"]
 %% Plan-006
 ...
 n009_4["Plan-007 Phase 4 — desktop repo attach UI"]
 %% Plan-008
 n010_3["Plan-008 Phase 3 — mode selection, run-setup gate, IPC"]
 n010_4["Plan-008 Phase 4 — desktop execution-mode picker"]
 %% Plan-009
 n011_1["Plan-009 Phase 1 — branch-context persistence"]
 n011_2["Plan-009 Phase 2 — diff artifact generation"]
 n011_3["Plan-009 Phase 3 — PR preparation and remote handoff"]
 n011_4["Plan-009 Phase 4 — desktop review surfaces"]
 %% Plan-010
 ...
 n014_3["Plan-012 Phase 3 — replication status, events, surfaces"]
 n014_4["Plan-012 Phase 4 — relay eager-pin upload"]
 n014_5["Plan-012 Phase 5 — authenticated relay fetch"]
 n014_6["Plan-012 Phase 6 — relay GC, quotas, backpressure"]
 n014_7["Plan-012 Phase 7 — erasure fan-out and degraded status"]
 %% Plan-013
 ...
 n017_3["Plan-015 Phase 3 — multi-agent OWN channel and human phase"]
 n017_4["Plan-015 Phase 4 — parallel execution and pool admission"]
 ...
 %% Plan-016
 n018_1["Plan-016 Phase 1 — user and presence contracts"]
 n018_2["Plan-016 Phase 2 — identity to user mapping"]
 n018_3["Plan-016 Phase 3 — presence aggregation and projection"]
 n018_4["Plan-016 Phase 4 — client surfaces and authorization"]
 n018_5["Plan-016 Phase 5 — credential seam and identity-key roster"]
 n018_6["Plan-016 Phase 6 — WebAuthn ceremony server side"]
 %% Plan-017
 n019_1["Plan-017 Phase 1 — attention contracts and trigger taxonomy"]
 n019_2["Plan-017 Phase 2 — preference storage and projections"]
 n019_3["Plan-017 Phase 3 — notification emission and delivery"]
 %% Plan-018
 n020_1["Plan-018 Phase 1 — health and recovery contracts"]
 n020_2["Plan-018 Phase 2 — daemon health projections and recovery"]
 n020_3["Plan-018 Phase 3 — Prometheus metrics exposition"]
 n020_4["Plan-018 Phase 4 — SDK and desktop recovery surfaces"]
 %% Plan-019
 n021_1["Plan-019 Phase 1 — rate-limit contracts and schema"]
 ...
 n022_4["Plan-020 Phase 4 — GDPR stub surface"]
 n022_5["Plan-020 Phase 5 — shred fan-out alignment checkpoint"]
 %% Plan-021
 n023_2["Plan-021 Phase 2 — IPC bridge registry and handlers"]
 n023_3["Plan-021 Phase 3 — daemon supervisor and crash reporter"]
 n023_4["Plan-021 Phase 4 — keystore, WebAuthn dispatcher, fallback"]
 n023_5["Plan-021 Phase 5 — auto-updater and deep-link handler"]
 n023_6["Plan-021 Phase 6 — renderer shell, router, composer"]
 ...
 %% Plan-023
 n026_1["Plan-023 Phase 1 — onboarding contracts and state substrate"]
 n026_2["Plan-023 Phase 2 — trust and credential primitives"]
 n026_3["Plan-023 Phase 3 — onboarding daemon service, IPC, events"]
 n026_4["Plan-023 Phase 4 — onboarding CLI surface"]
 n026_5["Plan-023 Phase 5 — onboarding desktop surface"]
 n026_6["Plan-023 Phase 6 — end-to-end option wiring"]
 n026_7["Plan-023 Phase 7 — provider authentication"]
 %% Plan-024
 n027_1["Plan-024 Phase 1 — dispatch contracts and migrations"]
 n027_2["Plan-024 Phase 2 — target-side intake and Cedar evaluation"]
 n027_3["Plan-024 Phase 3 — caller-side dispatch and outbox"]
 n027_4["Plan-024 Phase 4 — approval integration and dual-signed record"]
 n027_5["Plan-024 Phase 5 — caller-side result observation"]
 n027_6["Plan-024 Phase 6 — result buffering and desktop approval UI"]
 %% Plan-025
 ...
 n028_5["Plan-025 Phase 5 — MCP OAuth and client delivery"]
 %% Plan-026
 ...
 n031_3["Plan-028 Phase 3 — the relay"]
...
| --- | --- | --- | --- |
| 1 | [Plan-003 Phase 2](../plans/003-queue-steer-pause-resume.md) | queue admission and serialized interventions. | — |
|  | [Plan-004 Phase 3B](../plans/004-provider-driver-contract-and-capabilities.md) | provider-account seam and usage-limit signal. | — |
|  | [Plan-004 Phase 5](../plans/004-provider-driver-contract-and-capabilities.md) | MCP task-handle durability. | — |
|  | [Plan-005 Phase 3B](../plans/005-session-event-taxonomy-and-audit-log.md) | machine-authored content column. | — |
|  | [Plan-005 Phase 4](../plans/005-session-event-taxonomy-and-audit-log.md) | read side, SDK, desktop stub. | — |
...
|  | [Plan-007 Phase 3](../plans/007-repo-attachment-and-workspace-binding.md) | repo IPC namespace and SDK. | — |
|  | [Plan-009 Phase 1](../plans/009-gitflow-pr-and-diff-attribution.md) | branch-context persistence. | — |
...
|  | [Plan-014 Phase 1](../plans/014-multi-agent-channels-and-orchestration.md) | orchestration contracts and persistence. | — |
|  | [Plan-015 Phase 1](../plans/015-workflow-authoring-and-execution.md) | workflow contracts, schema, writer. | — |
|  | [Plan-016 Phase 1](../plans/016-identity-and-user-state.md) | user and presence contracts. | — |
|  | [Plan-017 Phase 1](../plans/017-notifications-and-attention-model.md) | attention contracts and trigger taxonomy. | — |
|  | [Plan-018 Phase 1](../plans/018-observability-and-failure-recovery.md) | health and recovery contracts. | — |
|  | [Plan-019 Phase 1](../plans/019-rate-limiting-policy.md) | rate-limit contracts and schema. | — |
|  | [Plan-022 Phase 3B](../plans/022-rust-pty-sidecar.md) | PTY substrate hardening. | — |
|  | [Plan-022 Phase 4](../plans/022-rust-pty-sidecar.md) | CI cross-compile matrix and signing. Waits on the code-signing credentials tracked as BL-108. | — |
...
|  | [Plan-009 Phase 3](../plans/009-gitflow-pr-and-diff-attribution.md) | PR preparation and remote handoff. | Plan-009 Phase 1 |
...
|  | [Plan-009 Phase 2](../plans/009-gitflow-pr-and-diff-attribution.md) | diff artifact generation. | Plan-009 Phase 1, Plan-012 Phase 2 |
...
|  | [Plan-020 Phase 1](../plans/020-data-retention-and-gdpr.md) | daemon master-key custody. | Plan-006 Phase R2 |
|  | [Plan-023 Phase 3](../plans/023-first-run-onboarding.md) | onboarding daemon service, IPC, events. | Plan-023 Phase 2 |
...
|  | [Plan-018 Phase 4](../plans/018-observability-and-failure-recovery.md) | SDK and desktop recovery surfaces. | Plan-018 Phase 3 |
|  | [Plan-019 Phase 4](../plans/019-rate-limiting-policy.md) | rate-limit observability and rollout. | Plan-019 Phase 3 |
|  | [Plan-020 Phase 2](../plans/020-data-retention-and-gdpr.md) | per-user crypto primitives. | Plan-020 Phase 1 |
|  | [Plan-021 Phase 2](../plans/021-desktop-shell-and-renderer.md) | IPC bridge registry and handlers. | Plan-006 Phase R3 |
|  | [Plan-023 Phase 4](../plans/023-first-run-onboarding.md) | onboarding CLI surface. | Plan-023 Phase 3 |
...
|  | [Plan-021 Phase 3](../plans/021-desktop-shell-and-renderer.md) | daemon supervisor and crash reporter. | Plan-021 Phase 2 |
|  | [Plan-023 Phase 6](../plans/023-first-run-onboarding.md) | end-to-end option wiring. | Plan-023 Phase 4, Plan-023 Phase 5 |
...
|  | [Plan-027 Phase 3](../plans/027-sidekick-definitions-and-peer-invocation.md) | resolution when a run starts. | Plan-014 Phase 3, Plan-026 Phase 2, Plan-027 Phase 2 |
...
| Sidekicks | [Plan-027 Phase 5](../plans/027-sidekick-definitions-and-peer-invocation.md) (the editor and the enablement control) | 9 |
...
|  | [Plan-026 Phase 4](../plans/026-provider-accounts-and-credential-homes.md) (the Providers page), [Plan-028 Phase 7](../plans/028-remote-control.md) (linked devices and the shared-ports list) | 5 |
