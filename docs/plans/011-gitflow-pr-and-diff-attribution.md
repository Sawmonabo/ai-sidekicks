...
**Precondition:** Tier-7 plan-readiness audit complete (NS-19; PR #160). Audit task 1; §Rollout Order step 1's branch-context half — the schema §Parallelization Notes gates both parallel service legs on.
