...
- **T22.5.2 — Path-2 anonymize-FK severance migration (V1 schema substrate).**
  ...
  - Spec coverage: Spec-022:407 (the `ON DELETE SET NULL` relaxation is enumerated **In V1**), Spec-022 §Shred Fan-Out Path-2 FK-safety; D-022-7
