...
- **T22.4.1 — Daemon JSON-RPC stub handlers.**
  ...
  - Spec coverage: Spec-022 §Non-Goals (post-V1 stubs), Spec-022:423 (unconditional not-implemented); ADR-009 (error envelope)
...
- **T22.5.2 — Path-2 anonymize-FK severance migration (V1 schema substrate).**
  ...
  - Spec coverage: Spec-022:412 (the `ON DELETE SET NULL` relaxation is enumerated **In V1**), Spec-022 §Shred Fan-Out Path-2 FK-safety; D-022-7
