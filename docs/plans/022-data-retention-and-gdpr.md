...
- **CP-022-6 — Path-2 fan-out (⇄ Plan-018/019/002/001) — reciprocals encoded.** Each Postgres owner carries the reciprocal Path-2 obligation (Spec-022:294-296): Plan-018 (`participants`, `identity_mappings` hard-DELETE), Plan-019 (`notification_preferences` hard-DELETE), Plan-002 (`session_invites` anonymize), Plan-001 (`session_memberships` anonymize). **Encoded** as fix-in-place amendment notes (project fix-in-place-over-rigid-ownership stance; not deferred to a V1.1 checkpoint): Plan-018 CP-018-11, Plan-019 §Cross-Plan Obligations (new), Plan-002 CP-002-8, Plan-001 CP-001-3 — each reciprocal is now live, satisfying I-022-19.
