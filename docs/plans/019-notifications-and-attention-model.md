...
1. Define attention categories, notification-preference contracts, and canonical trigger references in shared packages.
2. Implement replay-derived attention projection and preference storage with global defaults plus later extension points.
