...
- **Spec coverage:** Spec-019 §Required Behavior (the minimum trigger set — pending approval or input, run completion, run failure, sidekick mention); Spec-019 §Default Behavior (the actionable-versus-informational split)
