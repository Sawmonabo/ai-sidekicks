...
- [ ] Postgres backend enforces `sslmode=require` for self-host deployments (per BL-060 secure-by-default and Spec-021's deployment-aware abstraction).
