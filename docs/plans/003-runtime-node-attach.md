...
- **Spec coverage:** Spec-006 line 401 (payload base), line 403 (session binding), lines 407-413 (per-event payload shapes); api-payload-contracts.md §Plan-006 (capability payload typing).
