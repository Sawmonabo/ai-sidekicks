...
- [x] Paired spec is approved — dated note (2026-07-18, retiring the 2026-07-13 note): Spec-003 returned to `approved` via the campaign Task-28 / W1.5 batch re-promotion. All five of this plan's phases are shipped (Shipment Manifest) — no code dispatch currently gates on this box; the amendment's code leg belongs to Plan-024 Phase 3B.
