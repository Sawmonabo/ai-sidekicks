...
- **T28.4.7 — Recovery-attach composition-root wiring and the non-vacuous production assertion.**
  - Files: `packages/runtime-daemon/src/bootstrap/index.ts` (EXTEND — the sanctioned wiring-call edit, registered on the cross-plan-dependencies.md `bootstrap/` row at the 2026-08-12 targeted readiness audit)
