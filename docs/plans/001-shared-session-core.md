...
- **Lane B** (T5.4 — `spawn-cwd-translator.ts`): unblocks once [Plan-024 T-024-2-1](./024-rust-pty-sidecar.md) ships the `PtyHostContract` interface at `packages/contracts/src/pty-host.ts`.
