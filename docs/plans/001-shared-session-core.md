...
**Precondition:** Phase 5 cannot start until all three upstream Tier 1 substrates are merged:
...
- [Plan-023 Tier 1 Partial Phase 1](./023-desktop-shell-and-renderer.md#tier-1-partial-pr-sequence) — `apps/desktop/src/{main,preload,renderer}/` workspace package substrate (BL-101 (a) resolution): the directory tree + electron-vite v5 toolchain + minimal entrypoints that T5.2 + T5.3 below extend with content.
