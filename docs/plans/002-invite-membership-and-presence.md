...
| Pr5 | `activity.typing Awareness payload is exactly {channelId, since} and a typing set/clear cycle appends zero session_events rows` | I-002-5 no-content + no-durable-event invariant | I-002-5, `Spec-002 §Required Behavior`, `Spec-002 §State And Data Implications` |
