...
- **T4.5 — `RelayConnectionTokenIssuer` (relay connection-token custody, Plan-018-owned).**
  ...
  - Spec coverage: Spec-008:162 (300s-TTL `RelayNegotiationResponse.connectionToken`), Spec-008 §Relay Negotiation (connection-token issuance)
