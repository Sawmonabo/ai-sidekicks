...
### CP-007-5 — `security.default.*` event-type taxonomy registration owed to [Plan-006](./006-session-event-taxonomy-and-audit-log.md) / [Spec-006](../specs/006-event-taxonomy-and-integrity.md)
