...
V1 run nesting is depth-1 ([Spec-014 §Default Behavior](../specs/014-multi-agent-channels-and-orchestration.md#default-behavior)): a child run cannot create its own children, so "subtree" is always a flat set of direct children.
