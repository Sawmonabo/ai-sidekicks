...
- [ ] All declared `Depends On` specs are at `approved` status — Spec-004 (restored 2026-08-08, PR #299), Spec-006, Spec-012 (restored 2026-08-10, PR #317), and Spec-015 are `approved`; **Spec-014 and Spec-016 are `review`**, each pending its own restoring targeted readiness-audit delta. This box is the residual that keeps Plan-017 code dispatch bound to [AGENTS.md §Doc-First Discipline](../../AGENTS.md#doc-first-discipline) on those two specs, over and above Plan-017's own audit and status gates.
