# Spec-032: Connect an iOS app and drive control
...
[Plan-031](../plans/031-remote-control.md) complete through Phase 6. The phone is a device like any other, so it needs the relay, the method proxy, the registry, and attestation to already exist. Nothing in this spec re-specifies them.
...
- [Spec-031: Remote Control](031-remote-control.md)
