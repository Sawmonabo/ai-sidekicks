...
| `portable-pty` crates.io listing | Documentation (crate listing) | Latest crates.io version `0.9.0`; mature; used outside wezterm in Tauri terminal apps | <https://crates.io/crates/portable-pty> |
