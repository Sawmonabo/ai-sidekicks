...
- [BL-111](../backlog.md#bl-111-emit-per-session-onexit-on-rustsidecarptyhost-sidecar-crash) — backlog item closed by §Decision item 9 + the subsequent implementation PR.
