...
- [systemd unit StartLimit defaults](https://www.freedesktop.org/software/systemd/man/latest/systemd.unit.html) — the crash-budget precedent (5 starts / 10 s) the 5/60 s budget parallels
