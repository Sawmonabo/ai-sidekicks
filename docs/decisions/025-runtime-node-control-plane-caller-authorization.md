...
| `docs/superpowers/specs/2026-07-09-bl-resolution-campaign-design.md` §3.1, §4.A | Repo (approved design) | The ratified content contract for this ADR: decisions 1–9, the three Plan-002 tasks, the invariant changes, and the suite-migration list. This ADR adopts 1–3 and 5–9 unchanged and **supersedes decision 4's negative shape**, ratified 2026-08-10 (§Adjudication Record); the campaign plan's Task 2 is corrected in the same PR | [2026-07-09-bl-resolution-campaign-design.md §4.A Unit A — BL-141 caller-ownership authorization (P1)](../superpowers/specs/2026-07-09-bl-resolution-campaign-design.md#4a-unit-a--bl-141-caller-ownership-authorization-p1) |
