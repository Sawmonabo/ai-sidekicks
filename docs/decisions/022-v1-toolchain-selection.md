...
- [ADR-016: Electron Desktop Shell](./016-electron-desktop-shell.md) — sets the Electron floor that forces the tier-1 Node target (Electron 41 at authoring; amended 2026-09-01 to the 42 / 43 / 44 supported-branch subset with V1 on 44.x, whose bundled Node is 24.19 — the `>= 22.12.0` engines floor is unmoved).
