...
| Electron releases feed (2026-09-01 amendment) | Registry | `modules` (Node ABI) 145 for 41.x, 146 for 42.x, 148 for 43.x, **149** for 44.x; 44.1.1 bundles Node 24.19.0, and so does 44.1.0, the release the pin resolves to (measured on the installed binary 2026-09-01: Electron 44.1.0 / Chromium 152.0.7977.65 / Node 24.19.0) | <https://releases.electronjs.org/releases.json> |
