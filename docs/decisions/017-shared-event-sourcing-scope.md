...
| Opus 4.7 research synthesis (2026-04-17) | AI-assisted primary-source aggregation | Load-bearing conclusion: the discriminator for V1 is not ecosystem trend alone; it is the zero-knowledge relay constraint from ADR-010 | `.claude/scratch/adr-017-research-synthesis.md` (session-local) |
