...
| 2026-07-18 | Amended — W1.5 residual gate discharged | Status reconciliation only (campaign Task 28, W1.5 batch re-promotion): the 2026-07-13 row's residual-gate clause is superseded — [Spec-003](../specs/003-queue-steer-pause-resume.md), [Spec-005](../specs/005-session-event-taxonomy-and-audit-log.md), and [Spec-013](../specs/013-persistence-recovery-and-replay.md), with the other six W1-amended specs, re-promoted `review` → `approved` 2026-07-18 per the [runbook §Spec-Status Promotion Gate](../operations/plan-implementation-readiness-audit-runbook.md); implementation of the amended surfaces rides the campaign's W2 plan-task bundles. Rulings and core Option B decision unchanged; ADR stays `accepted`. |
