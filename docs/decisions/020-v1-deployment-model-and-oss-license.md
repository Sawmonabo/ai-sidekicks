...
| GitLab Self-Managed Platform Team handbook | Primary source | GitLab maintains full Self-Managed Platform Team + Scalability Working Group + Delivery group; structural evidence for the "self-host is multi-team commitment" claim | <https://handbook.gitlab.com/handbook/engineering/infrastructure/test-platform/self-managed-platform-team/> |
