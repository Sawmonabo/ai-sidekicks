...
- Modify: `docs/plans/008-control-plane-relay-and-session-join.md` (I-008-4 endpoint list adds the five runtimenode procedures; Plan-008 promoted `approved` 2026-07-21 (W2.5 re-audit #239) — re-adjudicate the amendment under the Status Flip Rule in the PR, expected stays-`approved` as defect-repair).
