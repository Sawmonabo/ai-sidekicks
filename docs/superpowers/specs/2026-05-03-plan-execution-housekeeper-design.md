...
- References: [Plan-001](../../plans/001-shared-session-core.md):12, 55, 122, 184, 298, 307, 309, 329, 338, 340 (line numbers post-NS-12 — `0001-initial.sql` cites); [Plan-022](../../plans/022-data-retention-and-gdpr.md):22, 52, 110, 232 (fourth cite re-anchored 2026-07-08: pre-shift :223 was already stale — the fourth `0001-initial` cite line is 232; the first two are pre-insert, the last two carry +1 for the 2026-07-08 preconditions insert and +1 for the 2026-07-09 `artifact_encryption_keys` PII-data-map row); [ADR-022](../../decisions/022-v1-toolchain-selection.md):14, 299; [Plan-001](../../plans/001-shared-session-core.md):369 `session.ts:388` cite (post-NS-12 line); [Plan-008](../../plans/008-control-plane-relay-and-session-join.md):28, 275 `session.ts:388` cite (line 188 → 199 post-Plan-008 Phase 1 YAML backfill)
