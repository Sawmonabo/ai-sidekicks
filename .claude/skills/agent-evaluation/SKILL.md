...
When the evaluator produces unparsable or incomplete output:

1. **Mark as invalid and ignore for analysis** - incorrect output, usually means hallucinations during thinking process

2. **Retry initial prompt without changes** - multiple retries usually more consistent rather than one shot prompt
