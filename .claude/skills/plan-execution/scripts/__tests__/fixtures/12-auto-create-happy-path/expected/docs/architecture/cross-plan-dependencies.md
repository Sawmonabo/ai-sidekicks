...
- Exit Criteria: Auto-create `reservedNsNn`=23; manifest emits exit 0 with `semantic_work_pending`=`SEMANTIC_WORK_PENDING_AUTO_CREATE` and an empty `mechanical_edits`.
