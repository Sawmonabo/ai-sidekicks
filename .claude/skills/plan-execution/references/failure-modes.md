...
> # → GATE verdict=<ack_clean|ack_with_findings|ack_findings_no_threads|ack_unsettled|ack_without_verdict|signal_truncated|no_ack_yet|rate_limited|draft_not_eligible|head_moved> ack= unresolved= ci= state= merge_state= merge_ok= head_sha=
> ```
>
