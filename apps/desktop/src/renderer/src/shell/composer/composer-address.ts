...
// They are separate zones behind separate barrels so separate lanes can fill them.
// Calling one hook twice is one implementation with two readers; handing the answer
// down from the host would have made the host know what every zone is for.
