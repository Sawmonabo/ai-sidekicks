...
export function registerConsoleFamilies(
  ...
  // — and three of the sidebar's eight sections, so it takes those two boards this
  // function was handed and no other registry, because those are the only claims it
  // makes.
