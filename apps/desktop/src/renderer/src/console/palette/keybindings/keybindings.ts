...
import type { CommandInvocationOutcome, CommandRegistry, KeyBinding } from "../commands/index.js";
...
import { evaluateWhenClause, type WhenClauseContext } from "../when-clause/index.js";
