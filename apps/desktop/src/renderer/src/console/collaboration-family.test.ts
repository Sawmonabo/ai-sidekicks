...
describe("collaboration family — composition", () => {
  it("claims the three slots this family owns", () => {
    ...
    registerCollaborationFamily(surfaces, sections, bindings, standInComposition);
  ...
  it("composes into the registry it is handed, not a singleton", () => {
    ...
    registerCollaborationFamily(first.surfaces, first.sections, first.bindings, standInComposition);
