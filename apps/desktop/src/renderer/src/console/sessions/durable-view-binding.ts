...
// `settings/pages/shell-preferences-holder.ts` records against its own first shape.
 ...
 * `settings/pages/shell-preferences-holder.ts` and `agents/agent-console-model.ts`.
