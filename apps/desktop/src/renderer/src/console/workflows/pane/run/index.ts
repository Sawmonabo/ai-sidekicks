...
// and it reaches this module by a deep intra-family specifier, which is what the
// module-shape rule in `apps/desktop/AGENTS.md` means by a sub-module door. Everything
// else under here is reached from inside the directory.
//
