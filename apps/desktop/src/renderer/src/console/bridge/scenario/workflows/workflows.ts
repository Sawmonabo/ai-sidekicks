...
// among its own beats is untouched. `scenario/workflows/chronology.test.ts` holds the
// rule.
//
// EVERY ID IS THE UUID THE WIRE DECLARES. `scenario/wire-truth/wire-truth.ts` presents each beat
