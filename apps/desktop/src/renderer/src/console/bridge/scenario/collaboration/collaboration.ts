...
// `SessionEventType`) CARRYING THE REGISTERED PAYLOAD, and `scenario/wire-truth/wire-truth.ts`
...
import { COLLABORATION_ACTIVITY } from "./activity.js";
...
import { COLLABORATION_REPLIES } from "./replies.js";
import { collaborationRuntimeNodeRoster } from "./runtime-nodes.js";
