...
import { LEDGER_FIRST_SIXTY_SCENARIO_ID } from "./ledger-scenario-id.js";

// Re-exported so the corpus still looks this id up beside the scenario it names. The
// declaration itself lives in a leaf, because production reads it and an import edge
// is per module: see that file's header.
export { LEDGER_FIRST_SIXTY_SCENARIO_ID };
