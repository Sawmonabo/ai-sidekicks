...
import type { ScenarioBeat, ScenarioRuntimeNodeRosterFrame } from "../runtime/index.js";
 ...
 * `scenario/wire-truth/wire-truth.ts` holds all of them to both. Three payload shapes appear
