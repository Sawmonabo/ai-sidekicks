...
// Reading one member off a value nothing typed. Published because two siblings take
// it from opposite sides of the scripted-reply seam this directory owns — `fixture/`
// answers a request with it, `scenarios/` derives what a scenario declares with it —
// and the seam, not either caller, is what the pair is about.
export { readUnknownMember, readUnknownStringMember } from "./unknown-member.js";
