...
// in it.
//
// WHY THIS PLANE HAS A MODULE. `fixture-workflow-reads.ts` and
// `fixture-diagnostics-reads.ts` beside it state the shape — a plane whose answers need
...
// is `fixture-mcp-inventory.ts`', whose header carries the whole of it. What is HERE is
