...
// them, `fixture-diagnostics-reads.ts` the five the settings page's diagnostics regions
...
// settlement onto an outcome — including the script-only disposition those planes and
// this port all take.
//
