...
//
// Lifted out of `fixture-growth-port.ts` beside `fixture/fixture-workflow-scope.ts`, on the
// precedent that port set for `fixture/fixture-session-directory.ts` and
...
// `fixture/fixture-workflow-scope.ts`, which reads it out of the replies themselves.
//
