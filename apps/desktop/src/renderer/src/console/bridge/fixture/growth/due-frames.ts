...
// {@link frameDueAt} — hoisted out of `shell/shell-status.ts`, which declared it
...
// either is edited.
//
// `settings/runtime-node-roster.ts` KEEPS ITS OWN and is not folded in here. Its reader
