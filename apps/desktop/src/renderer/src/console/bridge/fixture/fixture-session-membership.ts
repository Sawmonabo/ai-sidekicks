...
//
// THE FACT ONE READING SHORT OF THE TRUTH. `fixture-session-snapshot.ts` derives what a
...
//
// SO THE COUNT IS A FOLD, on `fixture-channel-directory.ts`'s own rule for the plane
