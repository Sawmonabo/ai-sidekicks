...
// and stamped with what each delivery records by `pending-invite-arrivals.ts`,
...
import {
  ...
  type PendingEntry,
  type RefusedEntry,
} from "./pending-invite-arrivals.js";
import { FixtureGrowthStream } from "../growth/growth-stream.js";
