...
//
// A SIBLING OF `fixture-bridge.test-support.ts` RATHER THAN A RESIDENT OF IT. That module
 ...
 * one an author wrote — the discipline `fixture-channel-lifecycle.ts` already keeps for
