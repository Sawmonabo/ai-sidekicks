...
// `fixture-onboarding-answers.ts` beside it state the shape — a plane whose answers
...
// — is `fixture-shell-status.ts`', whose header carries the whole of it. What is HERE is
