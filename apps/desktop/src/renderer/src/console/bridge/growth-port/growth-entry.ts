...
export type GrowthOperationId =
  ...
  // gitflow — the three of the four registered `gitflow.*` method strings this
  // console calls. `diffArtifactCreate` mints the diff artifact both diff surfaces
  // render; the fourth, `gitActionExecute`, is declared above with the act plane it
  // belongs to rather than here.
