...
//
// The row constructor and nothing else. It sits in its own module because ten plane
// modules call it and a helper declared in one of them would make the other nine
