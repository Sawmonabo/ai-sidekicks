...
// nobody projected — two distinct kinds of nothing, and a renderer that collapses
// them into one is wrong. So the expiry facet, whose own header states the
// three-answer rule, answers `null` with an explicit label and absence with the
// absence.
//
