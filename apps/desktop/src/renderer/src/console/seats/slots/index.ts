...
// timeline row slot, the window overlay seat, the owner slot, the inline-card seats,
// and the sidebar sections are read by the family door and by nothing beside it.
