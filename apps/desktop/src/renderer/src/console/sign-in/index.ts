...
// `App.tsx` composes window-scoped overlays and nothing else names a ceremony, a state,
// or the adapter. The stylesheet enters here because this directory owns it.
//
...
// caller — which is exactly what would make narrowing that surface a sweep instead of
// a one-file change.
