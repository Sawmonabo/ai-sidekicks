import { RESTORE_PATH_VISIBLE_ROW_CAP, RESTORE_PATH_ROW_HEIGHT_PX } from "../../core/index.js"; // What a restore-path enumeration is handed, and how tall its window may grow.
//
