...
// `refresh-scheduler.ts`. It is not the ordering rule — which settlement may install is
// the latch's, and this changes none of it. And it is not a timeout: nothing here arms a
