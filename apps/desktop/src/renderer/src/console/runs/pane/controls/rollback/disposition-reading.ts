// What a settled rollback says: the nine dispositions, read exhaustively.
//
...
// rendering anything.
//
// Its sibling `composite-guard.ts` answers the other half of a settled rollback —
// the refusal that carries no disposition at all. The two are separate modules
// because they read different members of different arms and share nothing: this one
