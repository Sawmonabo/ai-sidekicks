...
// its keyboard path. The one-click-away half is the console's own rule applied here:
// secondary controls live one click away — a row's hover footer or its context menu —
// never as a second visible button.
//
