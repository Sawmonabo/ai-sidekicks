...
// refusal, and the mount that was handed no bridge. A second centring wrapper in
// either would be two renderings of one idea, drifting apart the first time either
...
// arrangement of those mounts could write legally. It is a presentational wrapper
// that knows no family: a centred measure, a body slot, and the one hint that is true
// on every surface. That is the same class as `Nothing`, `InlineRefusal`, and
// `PartialRead` beside it, so it sits with them and every producer reaches DOWN.
//
