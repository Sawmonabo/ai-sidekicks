...
//
// The page's honesty rests on three things, and each has a case with its control:
// the numbers it shows are the ones it was told and never invented, a control names
// what it will interrupt before it does anything, and a refused control says so
...
function bridgeWith(ledger: ControlLedger, servesStatus: boolean): ConsoleBridge {
  const growth = {
...
function renderPage(options: {
  ...
  const context = settingsPageContextWith(
    bridgeWith(ledger, options.servesStatus ?? true),
    undefined,
    undefined,
