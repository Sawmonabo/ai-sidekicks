...
// that handed `deriveSessionHeader` a literal would be asserting against a ledger no session
...
import { deriveSessionHeader, type SessionHeaderModel } from "./session-header-model.js";
