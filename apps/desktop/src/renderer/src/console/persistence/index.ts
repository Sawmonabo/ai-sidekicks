...
// Until the durable adapter ships, the console runs on an in-memory adapter and reports
// that state in its own settings page — and a page that could not read the health reading
// would have had to infer durability from a write that failed, which reports a symptom
