...
//
// What the pane ASKS FOR is two other files: the grant re-read and the run its
// linkage is keyed by are `AgentConsolePane.reads.test.tsx`, and how long a linkage
// read lives is `AgentConsolePane.linkage-lifetime.test.tsx`.
