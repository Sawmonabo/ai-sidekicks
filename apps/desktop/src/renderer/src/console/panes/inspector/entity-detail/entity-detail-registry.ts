...
// kinds are declared once in `store/entities.ts`, and a twelfth added there should
// fail to compile HERE — where somebody has to decide what its record says —
...
// wrote a record for.
//
// The table is the only module that imports all eleven details, and none of them
