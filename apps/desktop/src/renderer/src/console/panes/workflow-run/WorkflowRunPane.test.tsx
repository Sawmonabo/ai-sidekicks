...
// The same instrument for the same reason, one slot along: the human form has no body
// anywhere in this repository, so which phase the pane opened reaches no markup. The
// park cards below say WHICH form is open in their own words, and this says the pane
// actually mounted it — two different claims, and neither substitutes for the other.
