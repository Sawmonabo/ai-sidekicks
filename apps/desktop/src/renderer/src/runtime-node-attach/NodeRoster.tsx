...
// status facets the wire entry carries (api-payload-contracts.md:543-553;
...
//       the registry row (api-payload-contracts.md:571).
...
//   api-payload-contracts.md:565-571, roster row :571; procedure-type
//   paragraph :568) — with the request/response wire shapes at
//   api-payload-contracts.md:536-556 and the contract pinned in Spec-003
...
// api-payload-contracts.md:571 (`query`, control-plane tRPC ONLY — the
