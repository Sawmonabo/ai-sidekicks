...
//      API-leak globals named by Spec-023 §Acceptance Criteria line 601.
//   5. `window.global` is `undefined` — the third Node-API-leak global
//      named by Spec-023 §Acceptance Criteria line 601. With this third
//      assertion the Tier 1 smoke covers the full Spec-023 line 601 set
...
describe("Plan-023 Phase 1 — substrate-boots smoke", () => {
  ...
  it(
    ...
    async () => {
      ...
      // leak into the renderer. Spec-023 §Acceptance Criteria line 601:
