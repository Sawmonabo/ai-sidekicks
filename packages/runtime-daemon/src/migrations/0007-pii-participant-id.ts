...
//   * No FOREIGN KEY to `participant_keys`. Crypto-shred DELETEs the
...
//
// Invariant `PII_PARTICIPANT_ID_PAYLOAD_KEY` in `events/pii-indirection.ts`.

export const PII_PARTICIPANT_ID_MIGRATION_SQL: string = `
-- Owner: | Migration: 0007-pii-participant-id.ts (Tier 4 Phase 3)

-- The durable PII owner stamp: byte-equal to the participant id the codec
