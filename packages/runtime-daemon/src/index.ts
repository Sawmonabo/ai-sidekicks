...
//
// PR #3 ships the session storage + projection slice:
//   * SessionService — append + replay over Local SQLite (append guarded
//     test-only since 2026-07-28 precondition — durable production writes
//     belong to EventLogService)
...
//
// PR #5 will add a contracts-to-internal mapping layer that translates
