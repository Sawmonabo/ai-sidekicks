...
// --------------------------------------------------------------------------
// The canonical `CapabilityDetails` (api-payload-contracts.md:981-985 — the
...
// concern. (api-payload-contracts.md:990's bare `"provider-driver"` is only an
 ...
 * (api-payload-contracts.md:981-985). This is the form carried by the
