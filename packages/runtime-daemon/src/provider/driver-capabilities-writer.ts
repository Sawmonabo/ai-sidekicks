...
// --------------------------------------------------------------------------
// The canonical `CapabilityDetails` (api-payload-contracts.md:967-971 — the
...
// concern. (api-payload-contracts.md:976's bare `"provider-driver"` is only an
 ...
 * (api-payload-contracts.md:967-971). This is the form carried by the
