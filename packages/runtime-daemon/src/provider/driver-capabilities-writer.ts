...
// --------------------------------------------------------------------------
// The canonical `CapabilityDetails` (api-payload-contracts.md:987-991 — the
...
// concern. (api-payload-contracts.md:996's bare `"provider-driver"` is only an
 ...
 * (api-payload-contracts.md:987-991). This is the form carried by the
