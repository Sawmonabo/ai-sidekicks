...
// --------------------------------------------------------------------------
// The canonical `CapabilityDetails` (api-payload-contracts.md:973-977 — the
...
// concern. (api-payload-contracts.md:982's bare `"provider-driver"` is only an
 ...
 * (api-payload-contracts.md:973-977). This is the form carried by the
