...
// --------------------------------------------------------------------------
// The canonical `CapabilityDetails` (api-payload-contracts.md:966-970 — the
...
// concern. (api-payload-contracts.md:975's bare `"provider-driver"` is only an
 ...
 * (api-payload-contracts.md:966-970). This is the form carried by the
