...
// session events), line 109 (no implicit capability exposure on attach), line 127
...
export class NodeCapabilityService {
  ...
  constructor(
    ...
    // re-attaches (Spec-003:127) — it does NOT scan a per-session capability_declared
    ...
    // "has this node declared?" correct across serial re-attaches (Spec-003:127).
