...
//
// PR #1 wires a single sanity test that actually exercises Vitest's runtime (mock +
...
// browser packages — that lands in PR #2+ when test surface widens. The coverage
