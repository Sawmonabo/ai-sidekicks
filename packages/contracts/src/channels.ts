...
// --------------------------------------------------------------------------
// C5 — ChannelListRequest (Spec-002 line 87 + api-payload-contracts.md:440-442)
// --------------------------------------------------------------------------
//
// Exact wire shape:
//   `{sessionId: SessionId}`
...
// (api-payload-contracts.md:443-449):
...
// --------------------------------------------------------------------------
//
// Exact wire shape (api-payload-contracts.md:443-450):
