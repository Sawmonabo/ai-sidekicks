...
// docs/architecture/contracts/api-payload-contracts.md lines 448-455:
//
...
// --------------------------------------------------------------------------
// C5 — ChannelListRequest (Spec-002 line 87 + api-payload-contracts.md:450-452)
// --------------------------------------------------------------------------
//
// Exact wire shape:
//   `{sessionId: SessionId}`
...
// (api-payload-contracts.md:453-459):
...
// --------------------------------------------------------------------------
//
// Exact wire shape (api-payload-contracts.md:453-460):
