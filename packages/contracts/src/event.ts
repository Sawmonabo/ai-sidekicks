...
// the regex from api-payload-contracts.md line 472.
//
...
// --------------------------------------------------------------------------
//
// Mirrors the EventCategory registry in api-payload-contracts.md lines 794–821
...
// Spec-006:563 specifies that `category` participates in the canonical-bytes
...
//
// ORDER IS NOT LOAD-BEARING — Spec-006:560 specifies RFC 8785 JCS
...
// wire contract per api-payload-contracts.md line 476 is opaque `id: string`
...
const buildCommonShape = () => ({
  ...
  // wire contract per api-payload-contracts.md line 476 is `id: string`. A
  ...
  // `occurredAt` is ISO 8601 per api-payload-contracts.md line 479.
  ...
  // for the integrity protocol (Spec-006:563-565 — Z-suffixed UTC, ms
  ...
  // events (api-payload-contracts.md line 482 — "or null for system").
