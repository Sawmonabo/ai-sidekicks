...
// the regex from api-payload-contracts.md line 477.
//
...
// --------------------------------------------------------------------------
//
// Mirrors the EventCategory registry in api-payload-contracts.md lines 1013–1040
...
// wire contract per api-payload-contracts.md line 481 is opaque `id: string`
...
const buildCommonShape = () => ({
  ...
  // wire contract per api-payload-contracts.md line 481 is `id: string`. A
  ...
  // `occurredAt` is ISO 8601 per api-payload-contracts.md line 484.
  ...
  // events (api-payload-contracts.md line 487 — "or null for system").
