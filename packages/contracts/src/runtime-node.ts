...
// Payload` (api-payload-contracts.md §Plan-006, lines 757-769) carry NO base /
...
// tools: NormalizedProviderToolMetadata[]}`, api-payload-contracts.md:981-985)
...
// diff capability snapshots structurally — api-payload-contracts.md:996-1001),
