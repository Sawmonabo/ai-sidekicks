...
// Payload` (api-payload-contracts.md §Plan-006, lines 763-775) carry NO base /
...
// tools: NormalizedProviderToolMetadata[]}`, api-payload-contracts.md:987-991)
...
// diff capability snapshots structurally — api-payload-contracts.md:1002-1007),
