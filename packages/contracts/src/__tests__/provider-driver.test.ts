...
//   • AC1 (Spec-005:155) — a mock fully implementing `ProviderDriver` (all 10
...
//   • AC2 (Spec-005:156) — a capability flag outside the 7-flag
...
//
// Refs: Spec-005:155 (AC1 — driver implementable with no session-domain change),
// Spec-005:156 (AC2 — off-union capability flag is a type error), Spec-005:60
// (resume-failure surfacing), Spec-005:128 (idempotency default), Plan-005
...
// ===========================================================================
// AC1 (Spec-005:155) — a mock fully implementing `ProviderDriver` compiles.
// ===========================================================================
//
...
describe("ProviderDriver contract — AC1 (Spec-005:155): a mock implements all 10 ops", () => {
...
// ===========================================================================
// AC2 (Spec-005:156) — a capability flag outside the 7-flag union is a TS error.
// ===========================================================================
//
...
describe("ProviderDriver contract — AC2 (Spec-005:156): off-union capability flag is a type error", () => {
...
// (Spec-005:60: resume failure must surface provider-failure detail + a visible
...
// Spec-005:128 — an undeclared class is NOT a contract violation; the safe
