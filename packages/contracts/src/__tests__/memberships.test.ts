...
// at docs/architecture/contracts/api-payload-contracts.md lines 410-415.
//
...
//     snake_case set per api-payload-contracts.md:412 is
...
// =============================================================================
//
// Canonical wire form per api-payload-contracts.md lines 410-415:
//
...
describe("MembershipUpdateSchema (C3: discriminated union per Spec-002 line 83)", () => {
  ...
  // api-payload-contracts.md:412 uses snake_case `change_role` (NOT
  ...
  it("rejects kebab-case 'role-change' (canonical wire is snake_case 'change_role')", () => {
    ...
    // form per api-payload-contracts.md:412. This test fails loudly if a
  ...
  // ----------------------------------------------------------------------
  //
  // The canonical wire form per api-payload-contracts.md:410-420 omits both
