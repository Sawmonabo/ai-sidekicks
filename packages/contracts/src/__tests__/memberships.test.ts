...
//     snake_case set per api-payload-contracts.md:411 is
...
describe("MembershipUpdateSchema (C3: discriminated union per Spec-002 line 83)", () => {
  ...
  // api-payload-contracts.md:411 uses snake_case `change_role` (NOT
  ...
  it("rejects kebab-case 'role-change' (canonical wire is snake_case 'change_role')", () => {
    ...
    // form per api-payload-contracts.md:411. This test fails loudly if a
  ...
  // ----------------------------------------------------------------------
  //
  // The canonical wire form per api-payload-contracts.md:409-419 omits both
