...
// `VERSION_FLOOR_EXCEEDED` (`Spec-003 §Required Behavior`, Spec-003 AC4:130; ADR-018 §Decision
...
//
// Cites: `Spec-003 §Required Behavior`, Spec-003 AC4:130, I-003-1, ADR-018 §Decision #4 /
