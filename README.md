...
- **27 V1 implementation plans** (+ pending Plan-028 for feature #18, campaign B18) with step-by-step build instructions; 19 are `approved`, Plan-001 is `completed`, and 7 are in `review` (Plan-004, Plan-005, Plan-008, Plan-014, Plan-017, Plan-018, Plan-025)
