...
- **24 accepted ADRs** recording key design decisions (ADR-013 reserved-skipped; ADR-026 and ADR-027 are `proposed`) — ADR-025 (runtime-node control-plane caller authorization) landed `accepted` 2026-08-12, filling the reserved `025` gap
