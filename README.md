...
- **28 V1 implementation plans** with step-by-step build instructions; 21 are `approved` (Plan-016 flipped 2026-07-21 by the campaign B15 orchestration bundle and restored the same day by its W2.5 targeted re-audit — a joint spec+plan promotion; Plan-008 promoted 2026-07-21 by its W2.5 targeted re-audit — a standing `review`, never campaign-flipped; Plan-012 restored 2026-07-21 by its W2.5 targeted re-audit after the 2026-07-20 B13 flip; Plan-024 restored 2026-07-21 by its W2.5 targeted re-audit after the same-day B16 flip), Plan-001 is `completed`, 5 are in `review` (Plan-013 — flipped 2026-07-20 by the campaign B9 CP-004-13 superseded-turn consumer amendment, restored by the Tier-8 audit or an earlier batch gate — Plan-014, Plan-017, Plan-018, Plan-025), and Plan-028 is `draft` (feature #18's MCP governance, landed 2026-07-22 via campaign B18; its targeted readiness audit is the `draft → review` gate)
