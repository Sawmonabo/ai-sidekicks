...
- **27 V1 implementation plans** (+ pending Plan-028 for feature #18, campaign B18) with step-by-step build instructions; 19 are `approved` (Plan-016 flipped 2026-07-21 by the campaign B15 orchestration bundle and restored the same day by its W2.5 targeted re-audit — a joint spec+plan promotion; Plan-008 promoted 2026-07-21 by its W2.5 targeted re-audit — a standing `review`, never campaign-flipped), Plan-001 is `completed`, and 7 are in `review` (Plan-012 — flipped 2026-07-20 by the campaign B13 spawn-env/normalizer/posture amendment, restored by its W2.5 targeted re-audit — Plan-013 — flipped 2026-07-20 by the campaign B9 CP-004-13 superseded-turn consumer amendment, restored by the Tier-8 audit or an earlier batch gate — Plan-014, Plan-017, Plan-018, Plan-024 — flipped 2026-07-21 by the campaign B16 Phase 3B PTY-substrate-hardening amendment, restored by its W2.5 targeted re-audit — Plan-025)
