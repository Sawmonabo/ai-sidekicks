...
| Local Database | SQLite (WAL mode, 52 tables) |
| Shared Database | Postgres (22 tables) |
...
Implementation follows the tiered dependency graph defined in [`docs/architecture/cross-plan-dependencies.md`](docs/architecture/cross-plan-dependencies.md). V1 spans 27 implementation plans (a pending 28th — Plan-028 for feature #18's MCP governance — lands with the campaign's B18 bundle, and MCP-governance code is gated on it); Plan-001 Shared Session Core is `completed`, nine plans are in `review` (Plan-008, Plan-012 Approvals — flipped 2026-07-20 by the campaign B13 spawn-env/normalizer/posture amendment (new invariants I-012-20..22), restored by its W2.5 targeted re-audit, Plan-013 Live Timeline — flipped 2026-07-20 by the campaign B9 CP-004-13 superseded-turn consumer amendment, restored by the Tier-8 audit or an earlier batch gate, Plan-014 Artifacts — re-opened 2026-07-08 for the cross-node relay scope growth, Plan-016 Multi-Agent Channels — flipped 2026-07-21 by the campaign B15 orchestration bundle (mandatory T2.7 blocking-state sweep behavior + the I-016-14 two-exemption rewrite), restored by its W2.5 targeted re-audit, Plan-017 Workflow Authoring, Plan-018, Plan-024 Rust PTY Sidecar — flipped 2026-07-21 by the campaign B16 Phase 3B PTY-substrate-hardening amendment (new phase, invariants I-024-7..12), restored by its W2.5 targeted re-audit, Plan-025 Self-Hostable Node Relay), and the rest are `approved` — Plan-010 Worktree Lifecycle among them, flipped 2026-07-19 for the campaign B22 turn-snapshot Phase and restored 2026-07-20 by its W2.5 targeted re-audit (#220), and Plan-027 Cross-Node Dispatch likewise — flipped 2026-07-19 for the campaign B17 pending-dispatch table and restored 2026-07-20 by its W2.5 targeted re-audit (#227). Plan-004 Queue Steer Pause Resume joined them 2026-07-20 — a standing `review` (never campaign-flipped) promoted by its W2.5 targeted re-audit (#228) after the campaign B9 rollback/park bundle. Plan-005 Provider Driver Contract followed the same day — flipped 2026-07-20 for the campaign B10 driver-tasks bundle and restored by its W2.5 targeted re-audit (#229).
...
- **27 V1 implementation plans** (+ pending Plan-028 for feature #18, campaign B18) with step-by-step build instructions; 18 are `approved` (Plan-016 flipped 2026-07-21 by the campaign B15 orchestration bundle and restored the same day by its W2.5 targeted re-audit — a joint spec+plan promotion), Plan-001 is `completed`, and 8 are in `review` (Plan-008, Plan-012 — flipped 2026-07-20 by the campaign B13 spawn-env/normalizer/posture amendment, restored by its W2.5 targeted re-audit — Plan-013 — flipped 2026-07-20 by the campaign B9 CP-004-13 superseded-turn consumer amendment, restored by the Tier-8 audit or an earlier batch gate — Plan-014, Plan-017, Plan-018, Plan-024 — flipped 2026-07-21 by the campaign B16 Phase 3B PTY-substrate-hardening amendment, restored by its W2.5 targeted re-audit — Plan-025)
- **27 specifications** covering every original feature and cross-cutting concern (25 `approved` — including the nine W1-amended specs re-promoted 2026-07-18 via the campaign's W1.5 batch gate (Task 28), Spec-003/004/005/006/010/012/015/016/024 — Spec-016 re-flipped `review` 2026-07-21 by the campaign B15 §Stop Conditions blocking-state exemption amendment and restored `approved` the same day by Plan-016's W2.5 targeted re-audit, a joint spec+plan promotion; 2 in `review` — Spec-014, re-opened 2026-07-08 for the cross-node artifact relay design, and Spec-013, flipped 2026-07-20 by the campaign B9 CP-004-13 superseded-turn consumer amendment, restored by the Tier-8 audit or an earlier batch gate) — the six campaign features are doc-gated: feature #18's Spec-028 is pending the B18 bundle, and features #19–#23's governing spec amendments are in-tree (B1 merged via #173, B3 merged 2026-07-05, B20 merged via #175, B6 landed 2026-07-06, B2 merged via #205; re-promoted via the W1.5 batch gate 2026-07-18; Spec-016 — the #20/#23 orchestration surface — was re-flipped `review` 2026-07-21 by B15's §Stop Conditions amendment and restored `approved` the same day by Plan-016's W2.5 targeted re-audit; feature #18's B18 queued), so implementation of #18 waits on B18 and #19–#23 wait on the campaign's W2 plan-task bundles rather than the pre-campaign plans — plus one corpus-side gate: #19's superseded-turn timeline rendering also rides the Spec-013/Plan-013 CP-004-13 consumer leg (both `review` since 2026-07-20; restored at the Tier-8 audit or an earlier batch gate)
