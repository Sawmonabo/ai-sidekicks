...
| Local Database | SQLite (WAL mode, 54 tables) |
...
- **28 specifications** covering every feature and cross-cutting concern (24 `approved` — including the nine W1-amended specs re-promoted 2026-07-18 via the campaign's W1.5 batch gate (Task 28), Spec-003/004/005/006/010/012/015/016/024 — Spec-016 re-flipped `review` 2026-07-21 by the campaign B15 §Stop Conditions blocking-state exemption amendment and restored `approved` the same day by Plan-016's W2.5 targeted re-audit, a joint spec+plan promotion; 4 in `review` — Spec-014, re-opened 2026-07-08 for the cross-node artifact relay design; Spec-013, flipped 2026-07-20 by the campaign B9 CP-004-13 superseded-turn consumer amendment, restored by the Tier-8 audit or an earlier batch gate; Spec-006, flipped 2026-07-22 by the campaign B18 census amendment, restored by its named follow-on re-promotion; and Spec-028, landed at `review` 2026-07-22 with promotion as the campaign's W3 gate) — the six campaign features are doc-gated: feature #18's Spec-028 + Plan-028 landed 2026-07-22 via the B18 bundle, and features #19–#23's governing spec amendments are in-tree (B1 merged via #173, B3 merged 2026-07-05, B20 merged via #175, B6 landed 2026-07-06, B2 merged via #205; re-promoted via the W1.5 batch gate 2026-07-18; Spec-016 — the #20/#23 orchestration surface — was re-flipped `review` 2026-07-21 by B15's §Stop Conditions amendment and restored `approved` the same day by Plan-016's W2.5 targeted re-audit), so implementation of #18 waits on Plan-028's targeted readiness audit + status promotion and #19–#23 wait on the campaign's W2 plan-task bundles rather than the pre-campaign plans — plus one corpus-side gate: #19's superseded-turn timeline rendering also rides the Spec-013/Plan-013 CP-004-13 consumer leg (both `review` since 2026-07-20; restored at the Tier-8 audit or an earlier batch gate)
